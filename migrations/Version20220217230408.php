 ...
 */
final class Version20220217230408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, nbr_place INT NOT NULL, lieu VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_de DATE NOT NULL, date_fi DATE NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
